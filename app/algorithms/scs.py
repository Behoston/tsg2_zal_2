...
list_graph = DeBruijnGraph(["konstantynopolitanczykowianeczka"],5)
euler_graph=list_graph.eulerianPath()
print('4: ',euler_graph)

DeBruijnGraph(euler_graph,4).toDot(open('test.dot','w'),True)
os.system("dot -Tpdf test.dot -o picture.pdf")
